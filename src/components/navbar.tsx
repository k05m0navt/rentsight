    ...
    <nav className="bg-background border-b border-border p-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="hidden md:flex space-x-4">
          ...
          <Button variant="ghost" asChild><Link href="/rent_entries">Rents</Link></Button>
          <Button variant="ghost" asChild><Link href="/expense_entries">Expenses</Link></Button>
          <Button variant="ghost" asChild><Link href="/tags">Tags</Link></Button>
        </div>
