...
// Radix UI Select Components for new implementations
...
// Native HTML Select component that works with existing code
...
// Export Radix UI components for new implementations
export {
  SelectRadix,
  SelectGroup,
  SelectValue,
...
// Export native select as "Select" for backward compatibility with existing code
