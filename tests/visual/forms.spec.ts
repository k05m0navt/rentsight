  ...
  for (const theme of themes) {
    test.describe(`${theme} theme`, () => {
      ...
      test(`login form ${theme} theme`, async ({ page }) => {
        ...
        await expect(page).toHaveScreenshot(`login-form-${theme}.png`, {
          fullPage: true,
      ...
      test(`signup form ${theme} theme`, async ({ page }) => {
        ...
        await expect(page).toHaveScreenshot(`signup-form-${theme}.png`, {
          fullPage: true,
          maxDiffPixels: 4000, // Allow for font rendering differences across browsers
        });
      });
      ...
      test(`form input focus state ${theme} theme`, async ({ page, context }) => {
        ...
        await expect(page).toHaveScreenshot(`form-input-focus-${theme}.png`, {
      ...
      test(`form input filled state ${theme} theme`, async ({ page, context }) => {
        ...
        await expect(page).toHaveScreenshot(`form-input-filled-${theme}.png`, {
          fullPage: true,
          maxDiffPixels: 100,
        });
      });
      ...
      test(`form error state ${theme} theme`, async ({ page, context }) => {
        ...
        if ((await submitButton.count()) > 0) {
          ...
          await expect(page).toHaveScreenshot(`form-error-state-${theme}.png`, {
            fullPage: true,
            maxDiffPixels: 100,
          });
        }
